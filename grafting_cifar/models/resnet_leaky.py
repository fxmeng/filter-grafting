...
def resnet20_leaky(num_classes=10):
    return ResNet(BasicBlock, [3, 3, 3],num_classes)


def resnet32_leaky(num_classes=10):
    return ResNet(BasicBlock, [5, 5, 5],num_classes)


def resnet44_leaky(num_classes=10):
    return ResNet(BasicBlock, [7, 7, 7],num_classes)


def resnet56_leaky(num_classes=10):
    return ResNet(BasicBlock, [9, 9, 9],num_classes)


def resnet110_leaky(num_classes=10):
    return ResNet(BasicBlock, [18, 18, 18],num_classes)


def resnet1202_leaky(num_classes=10):
